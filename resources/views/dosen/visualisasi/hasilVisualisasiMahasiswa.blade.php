                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h6 class="fw-bold">Mata Kuliah Perhitungan CPL:</h6>
                                    <ol>
                                                ...
                                                <div class="col-5">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="course">
                                                         ...
                                                         <input type="text" name="npm" class="visually-hidden" value="{{$npm}}">
                                                         <input type="text" name="nama" class="visually-hidden" value="{{$nama}}">
...
{{-- Batas div yang mau dihilangkan jika belum ada --}}
<script>

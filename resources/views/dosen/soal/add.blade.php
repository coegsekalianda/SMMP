        ...
        <div class="card-body" id="tambah-soal">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div id="templatePenilaian">
                    <div class="form-floating tooltipa tooltipa">
                        <select id="kurikulum" name="kurikulum"  class="form-select form-control-lg" aria-label="select kurikulum" required readonly>
                            <option >{{ $latestData->kurikulum }}</option>
                            @foreach ($kurikulum as $kur )
                            <option value="{{$kur->tahun}}">{{$kur->tahun}}</option>
                            @endforeach
                        </select>
                        <span class="tooltiptext">Kolom ini terisi otomatis sesuai dengan yang di submit sebelumnnya</span>
                    ...
                    <div class="form-floating tooltipa">
                        <select id="prodi" name="prodi"  class="form-select form-control-lg" aria-label="select Prodi" required readonly>
                            <option >{{ $latestData->prodi }}</option>
                    ...
                    <div class="form-floating tooltipa">
                        <select id="kode_mk" name="kode_mk"  class="form-select form-control-lg" aria-label="select Mata Kuliah" required readonly>
                            <option >{{ $latestData->kode_mk }}</option>
                            @foreach ($rpss as $rps)
                    ...
                    <div class="form-floating tooltipa">
                        <select type="number" name="minggu" id="minggu" min="1" max="16" class="form-select form-control-lg" required readonly>
                            <option >{{ $latestData->minggu }}</option>
                        </select>
                        <span class="tooltiptext">Kolom ini terisi otomatis sesuai dengan yang di submit sebelumnnya</span>
                    ...
                    <div class="form-floating tooltipa">
                        <select id="jenis" name="jenis"  class="form-select form-control-lg" aria-label="select jenis" required readonly>
                            <option >{{ $latestData->jenis }}</option>
                    ...
                    <div class="form-floating tooltipa">
                        <select class="form-control" name="cpl[]" required>
                    ...
                    <div class="form-floating tooltipa">
                        ...
                        <select name="cpmk[]" class="js-example-basic-multiple form-select form-control-lg" multiple="multiple" required>
                            @foreach ($rpss as $rps)
...
<script>
    document.querySelectorAll('#kurikulum, #prodi, #kode_mk, #minggu, #jenis').forEach(function(element) {
